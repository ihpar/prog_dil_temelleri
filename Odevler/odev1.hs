...
Haskell'de listeler aynı tipte elemanlardan oluşmalıdır (homojen). Örn [1, "X"] geçerli bir liste değildir. 
...
Bir NestedList'e bir eleman ekleyen yardımcı fonksiyon ekle ismiyle hazır verilmiştir. Gerekirse kullanabilirsiniz.
